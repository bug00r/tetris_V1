...
CFLAGS=-std=c11 -Wpedantic -pedantic-errors -Wall -Wextra -Os
#-ggdb -O1
#-pg for profiling 
...
UI_SRC=main.c tetris_ui.c tetris_ui_sdl.c
UI_BIN=tetris.exe
UI_LIB=-ltetris -lmingw32 -lSDL2main -lSDL2 -static -lSDL2_ttf -lSDL2_mixer -lvorbisfile -lvorbis -lvorbisenc -logg -lfreetype6 -lz -lm \
...
all: createdir $(BUILDPATH)$(LIBNAME) $(BUILDPATH)$(UI_FONT) $(BUILDPATH)$(UI_SFX) $(BUILDPATH)$(UI_SFX2) \
			   $(BUILDPATH)$(UI_SFX3) $(BUILDPATH)$(UI_SFX4) $(BUILDPATH)$(TESTBIN) $(BUILDPATH)$(UI_BIN)
...
$(BUILDPATH)$(UI_BIN):
	$(CC) $(CFLAGS) $(UI_SRC) -o $(BUILDPATH)$(UI_BIN) $(INCLUDEDIR)  $(BUILDPATH)$(UI_FONT) $(BUILDPATH)$(UI_SFX) $(BUILDPATH)$(UI_SFX2) $(BUILDPATH)$(UI_SFX3) $(BUILDPATH)$(UI_SFX4) $(UI_LIBDIR) $(UI_LIB) $(debug)
